"""
Django settings for MoneyProj project.
...
SECRET_KEY = 'django-insecure-wf9s3hdopkuop3#y-rg39m3vxc@(ru*$!mjx+77a-0(1q90c(y'
...
WSGI_APPLICATION = 'MoneyProj.wsgi.application'
